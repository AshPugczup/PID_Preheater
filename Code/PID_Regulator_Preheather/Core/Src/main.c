...
int PID_value = 0;
//PID constants
float kp = 203;   float ki= 7.2;   float kd = 1.04;
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  if(sens_error == 0){
		  ...
		  if(set_temperature!=set_temperature_last){//zrobic aby nie odswiezalo sie cały czas
			  	  	  ssd1306_FillRectangle(5, 15, 44, 25, Black);
			  	  	  ssd1306_UpdateScreen();
